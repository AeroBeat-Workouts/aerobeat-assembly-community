## Temporary validation copy for assembly MediaPipe test scene.
extends Node

const DesktopSidecarRuntime = preload("res://addons/aerobeat-input-mediapipe/src/runtime/desktop_sidecar_runtime.gd")
const DesktopSidecarLauncher = preload("res://addons/aerobeat-input-mediapipe/src/process/desktop_sidecar_launcher.gd")
const ADDON_AUTOSTART_SCRIPT_PATH := "res://addons/aerobeat-input-mediapipe/src/autostart_manager.gd"
...
func _find_python() -> String:
	return DesktopSidecarRuntime.get_sidecar_python_path(ADDON_AUTOSTART_SCRIPT_PATH)

func _resolve_package_path(relative_path: String) -> String:
	return DesktopSidecarRuntime.resolve_package_path(ADDON_AUTOSTART_SCRIPT_PATH, relative_path)
...
func _get_sidecar_runtime_root() -> String:
	return DesktopSidecarRuntime.get_sidecar_runtime_root(ADDON_AUTOSTART_SCRIPT_PATH)

func _get_runtime_prepare_command_hint() -> String:
	return DesktopSidecarRuntime.get_runtime_prepare_command_hint(ADDON_AUTOSTART_SCRIPT_PATH, _get_runtime_mode())
