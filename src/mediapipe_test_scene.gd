...
1. Open terminal in the assembly addon checkout at addons/aerobeat-input-mediapipe
...
func _start_provider() -> void:
	var provider_script: GDScript = load("res://src/mediapipe_provider_test.gd")
	if provider_script:
...
func _start_camera_feed() -> void:
	...
	var CameraViewClass: GDScript = load("res://addons/aerobeat-input-mediapipe/src/camera_view.gd")
