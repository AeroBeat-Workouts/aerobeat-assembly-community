...
const MediaPipeConfig = preload("res://addons/aerobeat-input-mediapipe/src/config/mediapipe_config.gd")
const MediaPipeServer = preload("res://addons/aerobeat-input-mediapipe/src/server/mediapipe_server.gd")
